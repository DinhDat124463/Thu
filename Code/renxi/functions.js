...
function timeElapse() {
    var targetDate = new Date('2024-03-30T07:30:00'); // Ngày mục tiêu là 30/03 07:30
    var currentDate = new Date(); // Thời điểm hiện tại
...
// Gọi hàm để tính toán và hiển thị thời gian
timeElapse();
